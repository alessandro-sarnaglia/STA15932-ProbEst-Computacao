...
<table class=fragment>
  <tr style="border-bottom:none;text-align:center;">
    <td>$p_X(x) = P(X = x) = \frac{e^{-\lambda t}(\lambda t)^k}{k!}, \ \ \ k=0,1,2,\ldots.$</td>
  </tr>
</table>
...
<table>
  <tr style="border-bottom:none;text-align:center;">
    <td>$p_X(x) = P(X = x) = \frac{e^{-\lambda}\lambda^k}{k!}, \ \ \ k=0,1,2,\ldots.$</td>
  </tr>
</table>
:::
...
A seguir, veremos as distribuições Weibull e Lognormal mencionadas anteriormente.
:::
