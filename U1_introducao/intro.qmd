...
tab_op <- function(tbl){
  tab_options(data = tbl,
              table.font.size = "100%", table.border.top.color="#000000",
...
📚 DEVORE, Jay L. Probabilidade e estatística: para engenharia e ciências. São Paulo: Cengage Learning, 2012;

📚 MORETTIN, Pedro Alberto; BUSSAB, Wilton de Oliveira. Estatística básica. 8ª ed. São Paulo: Saraiva, 2013.
:::
:::
...
::: incremental
1.  Avaliação 1 ⟹ Unidades 1 e 2;
2.  Avaliação 2 ⟹ Unidade 3;
3.  Avaliação 3 ⟹ Unidade 4.
:::
...
::: fragment
[**Importante:**]{style="color: red;"} Se a diferença for muito grande, a comparação nos subgrupos fica comprometida.
:::
...
<table class="table-with-total-row">
  <thead>
    <tr>
      <th style="border-right:1pt solid;">Renda</th>
      <th>[$n_i$]{.fragment fragment-index=1}</th>
      <th>[$f_i$]{.fragment fragment-index=2}</th>
      <th>[$h_i$]{.fragment fragment-index=3 style="color:red;"}</th>
      <th>[$d_i$]{.fragment fragment-index=4 style="color:blue;"}</th>
    </tr>
  </thead>
  <tbody>
    <tr>
      <td style="border-right:1pt solid;">$[0,1]$</td>
      <td>[20]{.fragment fragment-index=1}</td>
      <td>[0,4]{.fragment fragment-index=2}</td>
      <td>[1]{.fragment fragment-index=3 style="color:red;"}</td>
      <td>[0,4]{.fragment fragment-index=4 style="color:blue;"}</td>
    </tr>
    <tr>
      <td style="border-right:1pt solid;">$(1,2]$</td>
      <td>[10]{.fragment fragment-index=1}</td>
      <td>[0,2]{.fragment fragment-index=2}</td>
      <td>[1]{.fragment fragment-index=3 style="color:red;"}</td>
      <td>[0,2]{.fragment fragment-index=4 style="color:blue;"}</td>
    </tr>
    <tr>
      <td style="border-right:1pt solid;">$(2,6]$</td>
      <td>[10]{.fragment fragment-index=1}</td>
      <td>[0,2]{.fragment fragment-index=2}</td>
      <td>[4]{.fragment fragment-index=3 style="color:red;"}</td>
      <td>[0,05]{.fragment fragment-index=4 style="color:blue;"}</td>
    </tr>
    <tr>
      <td style="border-right:1pt solid;">$(6,14]$</td>
      <td>[10]{.fragment fragment-index=1}</td>
      <td>[0,2]{.fragment fragment-index=2}</td>
      <td>[8]{.fragment fragment-index=3 style="color:red;"}</td>
      <td>[0,025]{.fragment fragment-index=4 style="color:blue;"}</td>
    </tr>
    <tr>
      <td style="border-right:1pt solid;">Total</td>
      <td>[50]{.fragment fragment-index=1}</td>
      <td>[1]{.fragment fragment-index=2}</td>
      <td>[14]{.fragment fragment-index=3 style="color:red;"}</td>
      <td>[$---$]{.fragment fragment-index=4 style="color:blue;"}</td>
    </tr>
  </tbody>
</table>

::: fragment
[**Observação:**]{style="color: blue;"} A frequência relativa 0,2:
:::

::: incremental
-   corresponde a 0,2 por unidade de renda ($d_2 = \text{0,2}$) no intervalo $(1,2]$;
-   corresponde a 0,05 por unidade de renda ($d_3 = \text{0,05}$) no intervalo $(2,6]$, ou seja, [fica mais espalhada nesse intervalo]{style="color: red;"};
-   corresponde a 0,025 por unidade de renda ($d_4 = \text{0,025}$) no intervalo $(6,14]$, ou seja, [fica **ainda** mais espalhada nesse intervalo]{style="color: red;"};
:::
...
plot(0, type='n', xlim=range(brs), ylim=c(0,max(frs, dss)), xlab='Renda', ylab='Densidade',
     frame.plot=F, axes=T)
rect(xleft = brs[-5], ybottom = 0, xright = brs[-1], ytop = dss, col = 'gray')
rect(xleft = c(1.5, 2), ybottom = 0, xright = c(2, 3), ytop = dss[2:3], col = 'orange')
```
...
rect(xleft = brs[-5], ybottom = 0, xright = brs[-1], ytop = dss, col = 'gray')
rect(xleft = c(1.5, 2), ybottom = 0, xright = c(2, 3), ytop = dss[2:3], col = 'orange')
arrows(x0 = 6, y0 = .2, x1 = 2, y1 = .025, length = .15)
text(x = 6, y = .2, labels = "Frequência estimada de (1.5, 3]", pos=4)
```
...
::: incremental
-   tendência da variável;
-   dispersão da variável.
:::

::: fragment
As medidas que estudaremos aqui são:
::: 

::: incremental
-   a média ([medida de tendência central]{style="color:red; "});
-   e a variância e o desvio-padrão ([medidas de dispersão]{style="color:red; "}).
::: 
